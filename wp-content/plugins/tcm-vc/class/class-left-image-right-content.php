...
if ( ! class_exists( 'LeftImageRightContent' ) ) {
	class LeftImageRightContent {
		/**
		 * Hook into WordPress.
		 *
		 * @return	void
		...
		function __construct() {
			// Initialize plugin.
			add_shortcode( 'left_image_right_content', array( $this, 'render_shortcode' ) );
		...
		public function create_shortcode() {
			...
			vc_map( array(
				'name' 			=> __( 'Left Image Right Content', TCM_VC ),				
				'base' 			=> 'left_image_right_content',
		...
		*/
		public function render_shortcode( $atts, $content, $tag ) {
			...
			$output .= 	"<div class='left-image-right-content inverse-md vc_row wpb_row vc_row-fluid vc_row-o-equal-height vc_row-o-equal-height vc_row-o-content-middle vc_row-flex ${extra_class}' id='${element_id}'>";
